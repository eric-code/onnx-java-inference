...
public final class OperatorContextSupport {

    public static final String META_KEY = "_meta";

    private OperatorContextSupport() {
    }
    ...
    public static String resolveInputField(Map<String, Object> ctx, Map<String, Object> params, String opName) {
        ...
        throw new IllegalArgumentException("算子 " + opName + " 未指定 field，且模型有 "
                + inputs.size() + " 个输入 " + names(inputs) + "，请显式声明 field 参数");
    }

    public static String resolveOutputField(Map<String, Object> ctx, Map<String, Object> params, String opName) {
        String explicit = readField(params);
        if (explicit != null) return explicit;
        ModelMeta m = meta(ctx);
